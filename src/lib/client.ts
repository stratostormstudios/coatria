...
export type Task = { id:string; title:string; description:string; status:string; revision:number; assigneeId:string|null; createdBy:string; submissionUrl:string|null; submissionSummary?:string; reviewNote:string|null; submittedBy?:string|null; submittedAgentId?:string|null; approvedBy?:string|null; approvedAgentId?:string|null; machineReviewId?:string|null; authorIds?:string[]; createdAt:string; updatedAt:string };
export type Message = { id:string; roomId:string|null; body:string; createdAt:string; userId:string; authorName:string };
export type Agent = { id:string;pluginInstallationId?:string|null; name:string; harness:string; description:string; status:string; conversationAccess?:'none'|'read'|'write'; invocationAccess?:'none'|'members'|'admins'; capabilities?:string[]; expiresAt?:string|null; createdBy:string; lastSeenAt:string|null };
