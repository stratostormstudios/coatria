...
- Bounds: fixed UTC expiry, at most 8 model steps, 2,048 output tokens per step, 80,000 total tokens and a 600-second model workflow deadline. Installation limits can shorten those ceilings.
