...
export const ARCHIVE_HOST_SOURCE_FILES=Object.freeze(['archive-host-package.mjs','build-archive-host-bundle.mjs','install-archive-host.mjs','run-archive-host.mts','media-sandbox-linux-canary.mts','media-sandbox-startup-diagnostic.mts','media-sandbox-launch.c','media-sandbox-probe.c','prepare-media-sandbox-ci.mjs','run-media-sandbox-ci.mjs','prepare-media-apparmor-ci.mjs','collect-media-apparmor-ci.mjs']);
