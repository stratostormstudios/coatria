...
export type StudioGeneratedClientPackage=StudioClientPackageBase&{schemaVersion:2;revisionRound?:{roundId:string;number:number;planSha256:string};files:StudioGeneratedClientDeliveryFile[]};
