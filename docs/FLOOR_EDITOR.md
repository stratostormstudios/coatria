...
There are at most 100 objects on a rectangular floor. This release does not add freeform wall drawing, multi-storey buildings, automatic seating assignments, arbitrary angles, multi-selection or CAD export. Spatial furniture does not itself create room conversations or grant access. The editor is not a building-code or real-world occupancy planning tool.
