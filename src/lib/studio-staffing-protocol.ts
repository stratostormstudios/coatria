...
const roleKey=z.enum(STUDIO_STAFFING_ROLE_KEYS).describe('Choose a curated specialist role. Quality review (qc) requires an independent human and cannot be assigned to an agent.');
