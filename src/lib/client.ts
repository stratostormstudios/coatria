...
export type Agent = { id:string; name:string; harness:string; description:string; status:string; conversationAccess?:'none'|'read'|'write'; invocationAccess?:'none'|'members'|'admins'; capabilities?:string[]; expiresAt?:string|null; createdBy:string; lastSeenAt:string|null };
