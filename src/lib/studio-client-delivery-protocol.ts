...
export type StudioClientPackage={schemaVersion:1;delivery:{id:string;name:string;preparedAt:string};project:{id:string;name:string;clientName:string;spec:Record<string,unknown>};sourceManifestSha256:string;reviewBasis:'independently_approved';artifacts:Array<{id:string;name:string;version:number;sha256:string}>;files:StudioClientDeliveryFile[]};
