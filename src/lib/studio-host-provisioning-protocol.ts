import {z} from 'zod';
import type {RuntimeConfigurationPin} from './company-runtime-preset';
...
export type StudioHostProvisionPlan={
 version:1;companyId:string;durationMinutes:number;reviewExpiresAt:string;runtimeConfiguration?:RuntimeConfigurationPin;
